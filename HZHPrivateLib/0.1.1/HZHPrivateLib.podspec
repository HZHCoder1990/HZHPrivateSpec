#
# Be sure to run `pod lib lint HZHPrivateLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.1'
  s.summary          = 'A short description of HZHPrivateLib.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'HZHPrivateLib' => ['HZHPrivateLib/Assets/*.png']
  # }
